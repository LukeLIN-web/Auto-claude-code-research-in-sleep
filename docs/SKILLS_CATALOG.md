...
| [`/figure-spec`](../skills/figure-spec/SKILL.md) | Blueprint-locked vector figures for method / architecture / workflow / pipeline diagrams — deterministic JSON → SVG renderer or hand-authored SVG, both checked by a deterministic label diff + print-size gate | None |
