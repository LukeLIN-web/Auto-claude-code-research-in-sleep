...
def _call_llm_detailed(messages, model=None):
    ...
    # Retry the primary with backoff, then the optional fallback model.
    ...
    for current_model in models:
        for attempt in range(MAX_ATTEMPTS_PER_MODEL):
            ...
            try:
                ...
                return None, f"API returned non-JSON response: {e}", None
            try:
    ...
    return None, (last_error or "All attempts failed"), None
