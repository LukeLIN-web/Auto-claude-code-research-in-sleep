...
[ -f "$FIGURE_VERIFIER" ] || { echo "ERROR: verify_figure.py not found next to the renderer nor under \$ARIS_REPO/skills/figure-spec/scripts/ — rerun install_aris_codex.sh to pick it up." >&2; exit 1; }
