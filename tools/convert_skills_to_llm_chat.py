...
REPLACEMENTS_TEXT: list[tuple[str, str]] = [
    ...
    # Description text
    ("Always pin `model: gpt-6-astra` + `config: {\"model_reasoning_effort\": \"max\"}` (deep-audit tier).",
    ...
    ("for new review threads\n  (`model: gpt-6-astra`, `config: {\"model_reasoning_effort\": \"max\"}`).",
     "for new review threads."),
    ("`model: gpt-6-astra`, `reasoning: max`", "the configured `LLM_MODEL`, deepest available reasoning"),
    ...
    ("ALWAYS pin `model: gpt-6-astra` + `config: {\"model_reasoning_effort\": \"max\"}` for reviews (deep-audit tier; capability fallback per `reviewer-routing.md`, never below `xhigh`)",
    ...
    ("via GPT-6-Astra max review", "via llm-chat MCP review"),
    ("GPT-6-Astra xhigh", "LLM reviewer"),
    ("GPT-6-Astra max", "LLM reviewer"),
    ...
    ("pin `model: gpt-6-astra` + `config: {\"model_reasoning_effort\": \"max\"}` (deep-audit tier)",
    ...
    ("with `model: gpt-6-astra`, `config: {model_reasoning_effort: xhigh}`, `sandbox: read-only`, fresh thread",
     "with a fresh thread"),
    ("with `model: gpt-6-astra`, `config: {model_reasoning_effort: max}`, `sandbox: read-only`, fresh thread",
     "with a fresh thread"),
    ("model_reasoning_effort: \"max\"", "# (reasoning effort not supported by llm-chat)"),
    ("model_reasoning_effort: \"xhigh\"", "# (reasoning effort not supported by llm-chat)"),
    ("model_reasoning_effort: max", "# (reasoning effort not supported by llm-chat)"),
    ("model_reasoning_effort: xhigh", "# (reasoning effort not supported by llm-chat)"),
    ("reasoning_effort: max", "# (reasoning effort not supported by llm-chat)"),
